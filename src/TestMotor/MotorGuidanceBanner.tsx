...
const MESSAGES: Record<MotorIssueCode, string> = {
	...
	BOTH_THUMBS_OVER_PALM: "Move both thumbs out away from your palms",
	LEFT_THUMB_OVER_PALM: "Move your left thumb out away from your palm",
	RIGHT_THUMB_OVER_PALM: "Move your right thumb out away from your palm",
