...
const MESSAGES: Record<MotorIssueCode, string> = {
	...
	BOTH_HANDS_MISALIGNED: "Turn both palms to face the camera",
	LEFT_HAND_MISALIGNED: "Turn your left palm to face the camera",
	RIGHT_HAND_MISALIGNED: "Turn your right palm to face the camera",
